...
export default class extends Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div id="svTrList" style={{float: "left"}}>
                    <b>Transactions</b>:
                    <br />
                    {list}
                </div>
    ...
    componentDidMount() {
        ...
        if (nodes.length > 0) {
            ...
            svInit(this.props.data, this.state.selection);
        }
    }
}
